describe('Login Page for Smartbear Software',()=> {
    ...
    it('Protractor delete selected orders', () => {
             element(by.id("ctl00_MainContent_orderGrid_ctl06_OrderSelector")).click()
            .then(() => element(by.id("ctl00_MainContent_orderGrid_ctl03_OrderSelector")).click())
            .then(() => element(by.name("ctl00$MainContent$btnDelete")).click())
