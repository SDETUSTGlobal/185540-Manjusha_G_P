describe('Login Page for Freelancer',()=> {
	it('Protractor Login', () => { 
			...
			.then(() => element(by.xpath('/html/body/app-root/app-logged-out-shell/app-login-page/fl-container/fl-bit/app-login/app-credentials-form/form/fl-input[1]/fl-bit/fl-bit/input')).sendKeys('manjusha96')) 
			.then(() => element(by.xpath('/html/body/app-root/app-logged-out-shell/app-login-page/fl-container/fl-bit/app-login/app-credentials-form/form/fl-input[2]/fl-bit/fl-bit/input')).sendKeys('Manjusha@96')) 
